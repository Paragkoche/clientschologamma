    ...
    <div className=''>
     ...
     <div className="">
      <div className="">
        ...
        <div name="" className={"text-[24px] font-semibold text-cyan-400 text-center"}>{findCommitteeNameById(type)}</div>
        <h3 className="text-[16px] font-semibold text-gray-400  text-center">{position}</h3>
      </div>
...
<Image src={photoUrl} width={300} height={300} alt='no Preview Available' className="md:w-[300px] md:h-[300px] rounded-full bg-slate-500  lg:absolute top-[15px] left-[20px] shadow-xl w-[200px] h-[200px] "></Image>
...
<div className="flex flex-row  justify-center space-x-5 mt-[30px] ">
  ...
  <Link href={facebookUrl?facebookUrl:'/'}  className='cursor-pointer flex justify-center items-center w-[50px] h-[50px] rounded-full text-[20px] bg-blue-400 text-black'><GrFacebookOption /></Link>
  <Link href={linkedinUrl?linkedinUrl:'/'} className='cursor-pointer flex justify-center items-center w-[50px] h-[50px] rounded-full text-[20px] bg-blue-300 text-black'><BiLogoLinkedin /></Link>
  <Link href={instragramUrl?instragramUrl:'/'} className='cursor-pointer flex justify-center items-center w-[50px] h-[50px] rounded-full text-[29px] bg-pink-500 text-black'><IoLogoInstagram /></Link>
